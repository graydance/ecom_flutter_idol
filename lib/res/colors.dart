...
class Colours {
  ...
  /// 主色调
  static const Color color_EA5228 = Color(0xFFEA5228);

  /// 辅色调
  static const Color color_F68A51 = Color(0xFFF68A51);

  /// 一级标题
  static const Color color_0F1015 = Color(0xFF0F1015);

  /// 二级内容
  static const Color color_555764 = Color(0xFF555764);

  /// 说明内容
  static const Color color_979AA9 = Color(0xFF979AA9);

  /// 辅助内容
  static const Color color_C4C5CD = Color(0xFFC4C5CD);

  /// 状态 辅助线
  static const Color color_E7E8EC = Color(0xFFE7E8EC);

  /// 搜索卡片
  static const Color color_EDEEF0 = Color(0xFFEDEEF0);

  /// 提示报错
  static const Color color_ED3544 = Color(0xFFED3544);

  /// TAG
  static const Color color_48B6EF = Color(0xFF48B6EF);
  ...
  static const Color color_444648 = Color(0xFF444648);
  static const Color color_28292A = Color(0xFF28292A);
  static const Color color_C3C4C4 = Color(0xFFC3C4C4);
  static const Color color_3B3F42 = Color(0xFF3B3F42);
  static const Color color_F4F5F6 = Color(0xFFF4F5F6);
  static const Color color_FFD457 = Color(0xFFFFD457);
  static const Color color_A2A2A2 = Color(0xFFA2A2A2);
  static const Color color_EA4E4E = Color(0xFFEA4E4E);
  static const Color color_F17F7F = Color(0xFFF17F7F);
