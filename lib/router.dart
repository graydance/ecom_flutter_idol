...
class IdolRoute {
  ...
  static void sendArguments<T extends Arguments>(BuildContext context, T arguments){
    StoreProvider.of<AppState>(context).dispatch(UpdateArgumentsAction<T>(arguments));
  }
  ...
  static Future<Object> startSignIn(BuildContext context, SignUpSignInArguments arguments) {
    debugPrint('context>>>${context.hashCode} global context>>>${Global.navigatorKey.currentContext}');
    StoreProvider.of<AppState>(context, listen: false).dispatch(UpdateArgumentsAction<SignUpSignInArguments>(arguments));
    return Navigator.of(context).pushNamedAndRemoveUntil(RouterPath.signIn, (Route<dynamic> route) => false);
  ...
  static Future<Object> startInnerWebView(BuildContext context, InnerWebViewArguments arguments){
    StoreProvider.of<AppState>(context).dispatch(UpdateArgumentsAction<InnerWebViewArguments>(arguments));
