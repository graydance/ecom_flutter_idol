...
class _BalanceScreenState extends State with SingleTickerProviderStateMixin {
          ...
          return Container(
            ...
            child: Stack(
              children: [
                ...
                //   padding:
                //       EdgeInsets.only(left: 10, top: 16, right: 10, bottom: 16),
                //   child: IconButton(
                //     icon: Icon(
                //       Icons.arrow_back_ios,
                //       color: Colours.color_444648,
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        //vm.dashboard.monetaryUnit + TextUtil.formatDoubleComma3(vm.dashboard.availableBalance/100),
                        style: TextStyle(
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'Balance('+ (withdrawInfo == null ? "\$" : withdrawInfo.monetaryUnit) + ')',
                            style: TextStyle(
                          ...
                          GestureDetector(
                            onTap: _tips('Money you\'ve earned but have yet to withdraw.'),
                            // message: 'Money you\'ve earned but have yet to withdraw.',
                            child: Icon(
                              Icons.info,
                              size: 15,
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      'Available(' + (withdrawInfo == null ? "\$" : withdrawInfo.monetaryUnit) + ')',
                                      style: TextStyle(
                                          color: Colours.color_A9A9A9,
                                          fontSize: 14),
                                    ),
                                    GestureDetector(
                                      onTap: _tips('Money you\'ve earned and yuo can withdraw now.'),
                                      // message: 'Money you\'ve earned and yuo can withdraw now.',
                                      child: Icon(
                                        Icons.info,
                                        size: 15,
                                        color: Colours.color_40A2A2A2,
                                ...
                                Column(
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          'Unavailable(' + (withdrawInfo == null ? "\$" : withdrawInfo.monetaryUnit) + ')',
                                          style: TextStyle(
                                              color: Colours.color_A9A9A9,
                                              fontSize: 14),
                                        ),
                                        GestureDetector(
                                          onTap: _tips('Money you\'ve earned but you can\'t withdraw now.\nThe money will available after the sale confirmed.'),
                                          //_showWithdrawNotSetAccountDialog(context),
                                          // message: 'Money you\'ve earned but you can\'t withdraw now.\nThe money will available after the sale confirmed.',
                                          child: Icon(
                                            Icons.info,
                                            size: 15,
                                            color: Colours.color_40A2A2A2,
                ...
                Container(
                  ...
                  child: IdolButton(
                    ...
                    listener: (status) =>
                        _withdraw(status, withdrawInfo?.withdraw),
                  ),
                ),
              ],
            ),
  ...
  _withdraw(IdolButtonStatus status, int availableAmount) {
    if (status == IdolButtonStatus.enable) {
      String paymentAccount = SpUtil.getString(KeyStore.PAYMENT_ACCOUNT);
      if (TextUtil.isEmpty(paymentAccount)) {
        _showNeedSetWithdrawAccountDialog(context, availableAmount);
      } else {
        IdolRoute.startDashboardWithdraw(context, availableAmount);
      }
    }
  }
  ...
  /// 未设置提现账户弹窗
  _showNeedSetWithdrawAccountDialog(BuildContext context, int availableAmount) {
    showDialog(
        context: context,
