...
class _GoodsListTabViewState extends State<GoodsListTabView>
  ...
  Widget _buildWidget(_ViewModel vm) {
    if (vm._myInfoGoodsListState is MyInfoGoodsListInitial || vm._myInfoGoodsListState is MyInfoGoodsListLoading) {
...
class _ViewModel {
  ...
  @override
  int get hashCode => _myInfoGoodsListState.hashCode;
}
